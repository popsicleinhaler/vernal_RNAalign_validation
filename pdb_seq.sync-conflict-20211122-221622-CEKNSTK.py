...
def run(i,N):
    ...
    print('Start')
    os.mkdir(os.path.join(os.getcwd(),'cifs','instance_cifs', str(i)+'_dir'))
    out = os.path.join(os.getcwd(),'cifs','instance_cifs',str(i)+'_dir','chain2_list'+str(i))
    print(os.getcwd())
    print(out)
    lis = open(out,'w')
    ...
    for n in tqdm(range(1,N+1)):
        try:
            out = get_substructure(gkm(i)['instance'+str(n)], str(i)+'_dir','_'+str(i)+'_instance'+str(n)+'_nov15_2',cif=True)
